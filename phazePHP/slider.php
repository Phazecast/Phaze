                    ...
                    <?php
                        ...
                        while ($podcast) { // uso o while pra continuar lendo o que tem no banco, tipo enquanto tiver podcast ele vai listar
                            ...
                            if($tipo == 0) // PODCAST
                            {
                                echo " 
                                    <div class='item'>
                                        <a href='individualPodcast.php?nomePodcast=$nome'>
                                            <img src='$imagem' alt='$nome' class='img-responsive' width='100%'>
                                        </a>
                                        <div class='carousel-caption'>
                                            <a href='individualPodcast.php?nomePodcast=$nome'><h1>$nome</h1></a>
                                        </div>
                                    </div>
                                ";
                            }
                            else if($tipo == 1) // MATERIA
                            {
                                echo "
                                    <div class='item active'>
                                        <a href='individualMateria.php?nomeMateria=$nome'>
                                            <img src='$imagem' alt='$nome' class='img-responsive' width='100%'>
                                        </a>
                                        <div class='carousel-caption'>
                                            <a href='individualMateria.php?nomeMateria=$nome'><h1>$nome</h1></a>
                                        </div>
                                    </div>
                                ";
                            }
